...
namespace DungeonRunners.Combat
{
    public static class CombatPackets
    {
            ...
            ResolvedEntitySynchInfo entitySynchInfo)
        {
            ...
            return BuildMonsterPacket(monster, behaviorId, skillsId, manipulatorsId, modifiersId, 0, 0, snapshot, entitySynchInfo);
        }
     ...
     ResolvedEntitySynchInfo entitySynchInfo)
        {
            ...
            writer.WriteByte(0x01);
            int modifierLocalIdGenerator = 0;
            int modifierIdGenerator = 0;
            writer.WriteInt32(modifierLocalIdGenerator);
            writer.WriteInt32(modifierIdGenerator);
            writer.WriteByte(0x00);
