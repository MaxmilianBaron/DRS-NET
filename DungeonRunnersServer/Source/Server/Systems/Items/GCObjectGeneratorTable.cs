...
namespace DungeonRunners.Gameplay
{
    ...
    public class GCObjectGeneratorTable
    {
        ...
        public List<LootDrop> GenerateMobLoot(Monster monster, IReadOnlyList<LootGenerationProfile> profiles, int startRecipientIndex, out int recipientAssignments)
        {
            ...
            RollTreasureData(treasure, drops, source, $"source=mob monster={monster.Name} gc={monster.GCType}", profiles, startRecipientIndex, ref recipientAssignments);
        ...
        private void RollTreasureData(CreatureTreasureData treasure, List<LootDrop> drops, string source, string fallbackContext, IReadOnlyList<LootGenerationProfile> profiles, int startRecipientIndex, ref int recipientAssignments)
        {
