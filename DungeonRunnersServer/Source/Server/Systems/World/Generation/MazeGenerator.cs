    ...
    public class MazeGenerator
    {
        ...
        private static readonly Dictionary<string, string[]> RoomTileVariants =
            new Dictionary<string, string[]>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                { "cave_small_hub_", new[] { "cave_small_hub_1e", "cave_small_hub_1n", "cave_small_hub_1s", "cave_small_hub_1w" } },
                { "dungeon_one_cave_small_tracks_down_", new[] { "dungeon_one_cave_small_tracks_down_1e", "dungeon_one_cave_small_tracks_down_1s", "dungeon_one_cave_small_tracks_down_1w" } },
                { "dungeon_one_cave_small_tracks_up_", new[] { "dungeon_one_cave_small_tracks_up_1n", "dungeon_one_cave_small_tracks_up_1s", "dungeon_one_cave_small_tracks_up_1w" } },
                { "dungeon_one_one_oneoff_entrance_", new[] { "dungeon_one_one_oneoff_entrance_1e" } },
                { "dungeon_one_one_quest_", new[] { "dungeon_one_one_quest_1n1s1w_A" } },
                { "dungeon_one_one_questgate_", new[] { "dungeon_one_one_questgate_1n_A", "dungeon_one_one_questgate_1s_A", "dungeon_one_one_questgate_1w_A" } },
                { "level_one_cave_small_squeakeasy_entrance_", new[] { "level_one_cave_small_squeakeasy_entrance_1s_A" } },
                { "cave_small_deadend_", new[] { "cave_small_deadend_1e_A", "cave_small_deadend_1n_A", "cave_small_deadend_1s_A", "cave_small_deadend_1w_A" } },
                { "dungeon_one_fizz_rock_deadend_", new[] { "dungeon_one_fizz_rock_deadend_1e_A", "dungeon_one_fizz_rock_deadend_1w_A" } },
                { "dungeon_one_fizz_rock_corner_", new[] { "dungeon_one_fizz_rock_corner_1n1e_A", "dungeon_one_fizz_rock_corner_1s1w_A" } },
                { "cave_small_corner_", new[] { "cave_small_corner_1e1s_A", "cave_small_corner_1n1e_A", "cave_small_corner_1n1w_A", "cave_small_corner_1s1w_A" } },
                { "cave_small_shrine_", new[] { "cave_small_shrine_1e1s1w", "cave_small_shrine_1n1e1s", "cave_small_shrine_1n1e1w", "cave_small_shrine_1n1s1w" } },
            };
        ...
        private void PlaceRoomNodes()
        {
            ...
            {
                if (Roll100("MazeGenerator::PlaceRooms:chance") > spec.Chance)
                    continue;
            ...
            for (int y = 0; y < Height; y++)
            {
                for (int x = 0; x < Width; x++)
                {
                    ...
                    if (string.IsNullOrEmpty(tileType))
                        tileType = BuildGeneratedTileType(tileSetPrefix, conns);
            ...
            for (int y = -1; y <= Height; y++)
            {
                for (int x = -1; x <= Width; x++)
                {
                    ...
                    if (!inBoundsTile && !padTile)
                        continue;
                    GenerateLayoutRaw("Tile::chooseVariant", $"grid=({x},{y});pad={padTile}");
                    if (inBoundsTile)
                    {
                        _worldCells.Add(logicalCells[y * Width + x]);
                        continue;
                    }
                    ...
                    _worldCells.Add(new MazeCell
                    {
                        ...
                        WorldGridY = y,
                        Connections = "0n",
                        TileType = BuildGeneratedTileType(tileSetPrefix, "0n"),
                        IsPadding = true,
                        WorldOriginFixedX = cellFixedX,
                        WorldOriginFixedY = cellFixedY,
        ...
        {
            if (string.Equals(tileSetPrefix, "cave_small_tileset_", StringComparison.OrdinalIgnoreCase)
                && string.Equals(connections, "0n", StringComparison.OrdinalIgnoreCase))
                return $"{tileSetPrefix}{connections}";
            return $"{tileSetPrefix}{connections}_a";
        }
