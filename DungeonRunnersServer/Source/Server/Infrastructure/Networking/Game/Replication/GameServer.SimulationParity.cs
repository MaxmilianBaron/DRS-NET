    ...
    public partial class GameServer
    {
        ...
        private SimulationParityTickEntity CaptureSimulationParityTickEntity(uint entityId, int rootOrdinal, List<RRConnection> connections)
        {
            ...
            if (CombatRuntime.Instance.IsMonsterEntity(entityId))
            {
                ...
                return new SimulationParityTickEntity
                {
                    ...
                    FollowMovementCommitArmed = monster.FollowMovementCommitArmed,
                    FollowMovementCommitPending = monster.FollowMovementCommitPending,
                    FollowMovementPendingCommitTick = monster.FollowMovementCommitPending ? monster.FollowMovementPendingCommitTick : null,
                    FollowMovementPendingX = monster.FollowMovementCommitPending ? monster.FollowMovementPendingFixedX : null,
                    FollowMovementPendingY = monster.FollowMovementCommitPending ? monster.FollowMovementPendingFixedY : null,
                    FollowMovementPendingZ = monster.FollowMovementCommitPending ? monster.FollowMovementPendingFixedZ : null,
                    FollowMovementPendingHeading = monster.FollowMovementCommitPending ? monster.FollowMovementPendingHeadingFixed : null,
                    FollowMovementPendingMovingThisFrame = monster.FollowMovementCommitPending ? monster.FollowMovementPendingMovingThisFrame : null,
            ...
            List<SimulationParityTickRng> rng)
        {
            ...
            foreach (SimulationParityTickEntity entity in entities)
            {
                ...
                MixSimulationParityHash(ref hash, entity.FollowMovementCommitArmed ?? false);
                MixSimulationParityHash(ref hash, entity.FollowMovementCommitPending ?? false);
                MixSimulationParityHash(ref hash, entity.FollowMovementPendingCommitTick ?? uint.MaxValue);
                MixSimulationParityHash(ref hash, entity.FollowMovementPendingX ?? int.MinValue);
                MixSimulationParityHash(ref hash, entity.FollowMovementPendingY ?? int.MinValue);
                MixSimulationParityHash(ref hash, entity.FollowMovementPendingZ ?? int.MinValue);
                MixSimulationParityHash(ref hash, entity.FollowMovementPendingHeading ?? int.MinValue);
                MixSimulationParityHash(ref hash, entity.FollowMovementPendingMovingThisFrame ?? false);
        ...
        private SimulationParityUnit CaptureSimulationParityMonster(RRConnection viewer, Monster monster, uint simulationTick)
        {
            ...
            int moverMode = monster.MoveInDirectionHeadingInit
                ? 3
                : monster.UnitMoverPathOwner != 0 || (hasWander && wander.HasTarget) ? 2 : 1;
            ...
            return new SimulationParityUnit
            {
                ...
                ServerState = includeDetail ? new
                {
                    ...
                    speedPerFrameF32,
                     ...
                     monster.FollowMovementCommitArmed,
                     monster.FollowMovementCommitPending,
                     monster.FollowMovementPendingCommitTick,
                     monster.FollowMovementPendingFixedX,
                     monster.FollowMovementPendingFixedY,
                     monster.FollowMovementPendingFixedZ,
                     monster.FollowMovementPendingHeadingFixed,
                     monster.FollowMovementPendingMovingThisFrame,
