...
namespace DungeonRunners.Core
{
    ...
    public sealed class SimulationParityTickEntity
    {
        ...
        public bool? MovingThisFrame { get; set; }
        public bool? FollowMovementCommitArmed { get; set; }
        public bool? FollowMovementCommitPending { get; set; }
        public uint? FollowMovementPendingCommitTick { get; set; }
        public int? FollowMovementPendingX { get; set; }
        public int? FollowMovementPendingY { get; set; }
        public int? FollowMovementPendingZ { get; set; }
        public int? FollowMovementPendingHeading { get; set; }
        public bool? FollowMovementPendingMovingThisFrame { get; set; }
