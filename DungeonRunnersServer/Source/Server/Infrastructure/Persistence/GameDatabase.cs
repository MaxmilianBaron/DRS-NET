...
namespace DungeonRunners.Database
{
    public static class GameDatabase
    {
        ...
        private static void ValidateTopology(SqliteConnection connection)
        {
            ...
            ValidateRequiredColumns(connection, "main", "characters", "id", "account_id", "name", "class_name", "current_zone", "zone_id", "position_fixed_x", "position_fixed_y", "position_fixed_z", "current_hp", "current_mana", "max_hp", "max_mana");
